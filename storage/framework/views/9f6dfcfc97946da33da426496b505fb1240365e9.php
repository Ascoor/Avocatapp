                ...
                <div class="profile clearfix">
                    <div class="profile_pic">
                        <?php if(Auth::guard('admin')->user()): ?>
                            ...
                            <?php else: ?>
                                <img src="<?php echo e(asset('public/upload/user-icon-placeholder.png')); ?>" class="img-circle profile_img"
                                     alt="">
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
                    <div class="profile_info">
                        ...
                        <h3> <?php echo e(Auth::guard('admin')->user()->first_name.' '.Auth::guard('admin')->user()->last_name); ?></h3>
                    </div>
                </div>
                <!-- /menu profile quick info -->
